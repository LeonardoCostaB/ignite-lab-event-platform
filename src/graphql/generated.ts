...
export type GetLessionBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessionBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const GetLessionBySlugDocument = gql`
...
/**
 * __useGetLessionBySlugQuery__
 *
 * To run a query within a React component, call `useGetLessionBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessionBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessionBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessionBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessionBySlugQuery, GetLessionBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessionBySlugQuery, GetLessionBySlugQueryVariables>(GetLessionBySlugDocument, options);
      }
export function useGetLessionBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessionBySlugQuery, GetLessionBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessionBySlugQuery, GetLessionBySlugQueryVariables>(GetLessionBySlugDocument, options);
        }
export type GetLessionBySlugQueryHookResult = ReturnType<typeof useGetLessionBySlugQuery>;
export type GetLessionBySlugLazyQueryHookResult = ReturnType<typeof useGetLessionBySlugLazyQuery>;
export type GetLessionBySlugQueryResult = Apollo.QueryResult<GetLessionBySlugQuery, GetLessionBySlugQueryVariables>;
